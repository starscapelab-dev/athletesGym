...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>auth/auth.css?v=<?= filemtime(__DIR__ . '/../auth/auth.css') ?>">
    <link rel="stylesheet" href="<?= BASE_URL ?>account/profile.css?v=<?= filemtime(__DIR__ . '/../account/profile.css') ?>">
