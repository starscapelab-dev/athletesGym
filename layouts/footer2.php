<footer class="text-white text-center text-lg-start" style="background-color: #000000; width: 100%; margin: 0; padding: 0;">
    ...
    <div class="container p-4" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                <h5 class="text-uppercase mb-4">Working hours</h5>

                <table class="table text-left text-white">
                    <tbody class="fw-normal">
                        <tr>
                            <td style="padding-right: 20px;">Saturday - Thursday:</td>
                            <td>6:00 am to 12:00 am</td>
                        </tr>
                        <tr>
                            <td style="padding-right: 20px; vertical-align: top;">Friday:</td>
                            <td>6:00 am to 11:00 am<br>1:00 pm to 12:00 am</td>
                        </tr>
                    </tbody>
                </table>
            </div>
  ...
  buttons.forEach(btn => {
    btn.addEventListener("click", function () {
      ...
      if (!selectedVariantId) {
        showCartMessage(this, "⚠️ Please select a color and size before adding to cart", "warning");
        return;
      }
      ...
      .then(data => {
        ...
        if (data.success === true) {
          ...
          showCartMessage(this, "❌ Error: " + (data.message || data.error || "Something went wrong."), "error");
        }
      })
      .catch(err => {
