...
<head>
    ...
    <link rel="stylesheet" href="assets/vendors/css/swiper.css">
    ...
    <header>
        <div class="container-fluid">
            <nav class="navbar navbar-expand-xl">
                <a class="navbar-brand p-0" href="index.php"> <img src="assets/images/logo/logo-white.png"
                        width="300px"> </a>
                <button class="menu-btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                ...
                <!-- <a class="nav-link common-btn secondary contact-btn d-xl-block d-none" href="contact.php">Contact</a> -->
            </nav>
        </div>
    </header>
    <!-- Header End -->